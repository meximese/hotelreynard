...
} from "@/components/reynardMorphShared";
...
export default function ReynardWordmarkMorphSvg({
  ...
  return (
    <div className={`reynard-morph reynard-morph--svg ${className ?? ""}`.trim()} ref={ref}>
      <div className="reynard-morph__viewport reynard-morph__viewport--svg" aria-label="REYNARD">
        {styles.map((letter) => (
          <svg
            key={letter.id}
